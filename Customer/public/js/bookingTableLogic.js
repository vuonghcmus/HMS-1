    ...
    return `
        <div class="row mb-3" id=form-input-${roomId}>
            <div class="col-4 mt-3">
                ...
                <input type="number" min="1" max="10" class="form-control" id="people-${roomId}" name="people-${roomId}" value="1" required>
            ...
            <div class="col-4 mt-3">
                ...
                <input type="date" class="form-control" id="checkin-${roomId}" name="checkin-${roomId}" required>
                <div class="invalid-feedback">
            ...
            <div class="col-4 mt-3">
                ...
                <input type="date" class="form-control" id="checkout-${roomId}" name="checkout-${roomId}" required>
                <div class="invalid-feedback">
                    Check in date must not be empty.
                </div>
            </div>
